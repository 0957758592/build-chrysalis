...
execSync('git clone --single-branch --branch development https://github.com/Dygmalab/chrysalis-api.git Build/chrysalis-api');
process.chdir("Build/chrysalis-api/");
execSync('yarn install --prefix');
execSync('git clone --single-branch --branch development https://github.com/Dygmalab/Chrysalis.git ../chrysalis/');
